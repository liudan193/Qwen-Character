...
from verl.third_party.latex2sympy2_extended.symbols import get_symbol
from verl.third_party.latex2sympy2_extended.math_normalization import normalize_latex, NormalizationConfig
from verl.third_party.latex2sympy2_extended.antlr_parser import PSParser, PSLexer
...
class _Latex2Sympy:
    def __init__(self, variable_values: dict  = None, is_real=None, convert_degrees: bool = False, config: ConversionConfig = ConversionConfig()):
        # Instance variables
...
def latex2sympy(latex_str: str, variable_values: dict = None, is_real=None, convert_degrees: bool = False, normalization_config: NormalizationConfig = NormalizationConfig(), conversion_config: ConversionConfig = ConversionConfig()):
