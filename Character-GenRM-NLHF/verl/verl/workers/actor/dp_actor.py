...
class DataParallelPPOActor(BasePPOActor):
    ...
    def compute_log_prob(self, data: DataProto, calculate_entropy=False) -> torch.Tensor:
        ...
        def _get_micro_batches(data: DataProto) -> Tuple[list, Union[list,  None]]:
        ...
        log_probs_lst = []
        entropy_lst = []
        for micro_batch in tqdm(micro_batches, desc="Compute logprobs"):
    ...
    def update_policy(self, data: DataProto):
        ...
        metrics = {}
        pbar =  tqdm(desc='Update policy', total=len(dataloader) * self.config.ppo_epochs)
