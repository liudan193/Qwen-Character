...
# News
- **[2026.05]** `RM-NLHF` has been accepted to ICML 2026! RM-NLHF proposes training a reward model using natural language instead of just preference labels as training rewards, leading to a Generative Reward Model (GRM) that achieves SOTA results on general reward model benchmarks. [[Code]](https://github.com/Tongyi-ConvAI/Qwen-Character/tree/main/Character-GenRM-NLHF) [[Paper]](https://arxiv.org/abs/2601.07349)
